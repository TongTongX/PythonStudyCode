...
def login():
    ...
    driver.get("https://www.facebook.com")
    driver.find_element_by_id('email').send_keys("alanzhaoxutong@hotmail.com")
    driver.find_element_by_id('pass').send_keys("cyc19960628face")
    ...
    email.send_keys("alanzhaoxutong@hotmail.com")
    time.sleep(1)
    password = driver.find_element_by_id('pass')
    password.send_keys("cyc19960628face")
    time.sleep(1)
